...
CREATE INDEX idx_tournaments_challonge_id ON tournaments(challonge_tournament_id);
CREATE INDEX idx_tournaments_registration_dates ON tournaments(registration_start_at, registration_end_at);
...
CREATE UNIQUE INDEX idx_tournament_registrations_unique ON tournament_registrations(tournament_id, user_id);
...
-- Update tournament_matches table to reference tournaments table
