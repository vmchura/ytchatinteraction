...
user.created = ¡Has creado exitosamente un usuario!

# Mensajes de autenticación
auth.login.required = Necesitas iniciar sesión para acceder a esta página.
auth.login.success = Has iniciado sesión exitosamente.
auth.logout.success = Has cerrado sesión exitosamente.
...
nav.login = Iniciar Sesión con Google
...
home.get.started = Comenzar con Google
...
login.signin.youtube = Iniciar sesión con Google
...
# Cambio de alias
alias.title = Cambiar Tu Alias
alias.subtitle = Actualiza tu nombre de visualización para personalizar tu perfil.
alias.current = Alias Actual:
alias.new.label = Nuevo Alias *
alias.new.placeholder = Ingresa tu nuevo alias
alias.new.help = Elige un nombre único entre 1-50 caracteres. Solo se permiten letras, números, espacios, guiones, guiones bajos y puntos.
alias.update.button = Actualizar Alias
alias.cancel.button = Cancelar
alias.note = Nota: Tu alias se usa para preservar tu privacidad mientras muestra tu nombre a otros usuarios. Puede cambiarse en cualquier momento. Puedes reutilizar cualquier alias que hayas usado anteriormente.
...
upload.table.actions = Acciones
upload.table.filename = Nombre de Archivo
upload.table.error = Error
upload.remove.file = Eliminar
upload.remove.file.tooltip = Eliminar este archivo de la sesión
upload.no.hash = N/A
upload.js.error.removing = Error al eliminar archivo. Por favor intenta de nuevo.
...
# Youtube Membership
youtube.no.subscriptions=No tienes subscripciones en los canales de StarCraft vinculados a esta plataforma.
youtube.my.follows=Mis canales de StarCraft
...
elo.global.race=Raza
elo.global.scpower=SCPower
elo.global.updated=Última Actualización

# Recent matches
match.recent.history.title=Partidas recientes
match.recent.no.history=Sin partidas
match.recent.firstUser=Player
match.recent.secondUser=Player
match.recent.winner=Ganador
match.recent.arena=Evento

casual.upload=Sube tu VS
