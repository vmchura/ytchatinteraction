...
class StreamerEventRepositorySpec extends PlaySpec with GuiceOneAppPerSuite with Injecting with BeforeAndAfterEach with MockitoSugar {
  ...
  "StreamerEventRepository" should {
    ...
    "get events by channel ID" in {
      ...
      val event1 = StreamerEvent(None, testChannelId1, testEventName1, None, testEventType, true, Instant.now(), None, None, None)
      val event2 = StreamerEvent(None, testChannelId1, testEventName2, None, testEventType, true, Instant.now(), None, None, None)
      ...
      val event3 = StreamerEvent(None, testChannelId2, "Other event", None, testEventType, true, Instant.now(), None, None, None)
    ...
    "get active events by channel ID" in {
      ...
      val activeEvent = StreamerEvent(None, testChannelId1, testEventName1, None, testEventType, true, Instant.now(), None, None, None)
      val inactiveEvent = StreamerEvent(None, testChannelId1, testEventName2, None, testEventType, false, Instant.now(), Some(Instant.now()), None, None)
    ...
    "get all active events" in {
      ...
      val activeEvent1 = StreamerEvent(None, testChannelId1, testEventName1, None, testEventType, true, Instant.now(), None, None, None)
      val activeEvent2 = StreamerEvent(None, testChannelId2, testEventName2, None, testEventType, true, Instant.now(), None, None, None)
      
      // Create an inactive event
      val inactiveEvent = StreamerEvent(None, testChannelId1, "Inactive event", None, testEventType, false, Instant.now(), Some(Instant.now()), None, None)
    ...
    "update an event" in {
      ...
      // Create an event
      val event = StreamerEvent(None, testChannelId1, testEventName1, None, testEventType, true, Instant.now(), None, None, None)
      val created = Await.result(repository.create(event), 5.seconds)
    ...
    "get the most recent active event for a streamer" in {
      ...
      val olderEvent = StreamerEvent(None, testChannelId1, "Older event", None, testEventType, true, olderTime, None, None, None)
      val newerEvent = StreamerEvent(None, testChannelId1, "Newer event", None, testEventType, true, now, None, None, None)
    ...
    "return None when no active events for streamer" in {
      ...
      // Create an inactive event
      val inactiveEvent = StreamerEvent(None, testChannelId1, testEventName1, None, testEventType, false, Instant.now(), Some(Instant.now()), None, None)
      Await.result(repository.create(inactiveEvent), 5.seconds)
    ...
    "throw exception when updating event without ID" in {
      ...
      val invalidEvent = StreamerEvent(None, testChannelId1, testEventName1, None, testEventType, true, Instant.now(), None, None, None)
